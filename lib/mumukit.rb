...
require_relative 'mumukit/test_hook/file_runner_hook'
require_relative 'mumukit/test_hook/with_mashup_file_content'
require_relative 'mumukit/test_hook/isolated_environment'
require_relative 'mumukit/test_hook/with_embedded_environment'
require_relative 'mumukit/test_hook/with_isolated_environment'
require_relative 'mumukit/request_validator_hook/request_validation_error'

require_relative 'mumukit/defaults/default_expectations_hook'
require_relative 'mumukit/defaults/default_query_hook'
require_relative 'mumukit/defaults/default_feedback_hook'
require_relative 'mumukit/defaults/default_validation_hook'
require_relative 'mumukit/defaults/default_test_hook'
require_relative 'mumukit/defaults/default_metadata_hook'
require_relative 'mumukit/defaults/default_test_hook'
