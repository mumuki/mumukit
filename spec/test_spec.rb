...
/*#anotherfile.js>*/'
  ...
  describe 'with multifile test hook' do
    let(:request) {
      req test: 'something', content: '
...
/*<File2.java#*/class File2 {}/*#File2.java>*/'
    ...
    before do
      ...
      class DemoTestHook < Mumukit::Templates::MultiFileHook
        ...
        def compile_file_content(request)
          request.content.merge('FileExtra.java' => 'autogenerated java file')
        end

        def command_line(*files)
          "cat #{files[0]} #{files[1]} #{files[2]}"
        end
      end
    end
    ...
    it { expect(result).to eq out: "class File1 {}class File2 {}autogenerated java file", exit: :passed }
  end

  describe 'with multifile test hook, same tempdir and rare file names' do
    let(:request) {
      req test: 'something', content: '
/*<Fi/le 1.java#*/class File1 {}/*#Fi/le 1.java>*/
/*<Fi/le 2.java#*/class File2 {}/*#Fi/le 2.java>*/'
    }
    ...
    it { expect(result[:out]).to match(/\/tmp\/([\w-]+)\/Fi_le_1\.java \/tmp\/\1\/Fi_le_2\.java\n/) }
    it { expect(result[:exit]).to eq :passed }
  end

  describe 'with multifile test hook in a backwards compatible test' do
    let(:request) {
      req test: 'something', content: 'some single content'
    }
    ...
    it { expect(result).to eq out: "some single content", exit: :passed }
  end
